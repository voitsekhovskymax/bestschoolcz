            ...
            <Card class="margin-top-10">
                <div class="photo_container" v-for="item in gallery.gallery_items">
                    <Row>
                        <Col span="12">
                        <!--<div class="item_link">-->
                            <!--<Input v-bind:id="item.local_name" :value="item.link" placeholder="Вставьте ссылку ">-->
                            <!--</Input>-->

                        <!--</div>-->
                        <div class="margin-top-10">
                            <Input type="textarea" :rows="4" v-model="item.source_code"
    ...
    export default {
        ...
        methods: {
            ...
            addVideo() {
                ...
                this.gallery.gallery_items.push(newVideo);
                count_videos++;
            },
