                    ...
                    <Row :gutter="10">
                        ...
                        <Col span="10" class="image-editor-con1">
                            ...
                            <div class="image-editor-con1-btn-con margin-top-10">
                                ...
                                <label class="filelabel" for="fileinput1"><Icon type="image"></Icon>&nbsp;Выбрать изображение</label>
                                <span><Button @click="handlecrop1" type="primary" icon="crop">Обрезать</Button></span>
                            </div>
            ...
            <Card>
                ...
                <Row :gutter="10">
                    ...
                    <Col span="6" class="image-editor-con3">
                        ...
                        <Row class="margin-top-10">
                            <Col span="24" class="crop3-btn-box">
                                <Button @click="handlecrop3" style="width: 190px;" icon="crop" type="primary">Обрезать</Button>
                            </Col>
                            <Modal v-model="option3.showCropedImage">
                                <p slot="header">Результат комплексного фото</p>
